...
export default function InviteStudentDialog({
  ...
  const handleInvite = async () => {
    ...
    try {
      ...
      toast.error(
        err?.message || "Failed to invite CE student"
      );
    } finally {
      setInviting(false);
    }
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="mt-1 text-xs text-slate-500">
                CE Training Portal access is not activated until this
                student&apos;s registration is settled.
              </p>
            </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-slate-600">
                    The student must complete their registration payment
                    before CE Training Portal access is activated.
                  </p>
                </div>
              </div>
            </label>
              ...
              <div className="ml-4 space-y-2 border-l-2 border-violet-200 pl-4">
                ...
                <label className="flex cursor-pointer items-start gap-2">
                  ...
                  <span>
                    ...
                    <span className="block text-xs text-slate-500">
                      The registration will be collected immediately in the
                      next payment step.
                    </span>
                  </span>
                </label>
                ...
                <label className="flex cursor-pointer items-start gap-2">
                  ...
                  <span>
                    ...
                    <span className="block text-xs text-slate-500">
                      The student remains pending until the cohort invoice
                      is settled for this registration.
                    </span>
                  </span>
                </label>
              </div>
