...
function mapTask(raw) {
  ...
  return {
    ...
    category: asString(raw.category, "follow_up"),
    due_date: raw.due_date ?? null,
    client_ids: asArray(raw.client_ids),
    recommendation_id: raw.recommendation_id ?? null,
    assigned_to_client: asBoolean(raw.assigned_to_client, false),
...
function mapTimeEntry(raw) {
  ...
  return {
    ...
    form_data: (typeof raw.form_data === "object" && raw.form_data) || null,
