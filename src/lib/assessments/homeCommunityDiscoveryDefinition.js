    ...
    questions: [
      {
        ...
        guidance: {
          purpose: "Capture what the client is drawn to—places, topics, causes, and environments—NOT the skills used or tasks performed. These are the client's passions and areas of fascination.",
          include: [
            "Libraries, office supplies, community service, donation centers",
            "Food pantry operations, church activities, volunteer opportunities",
            "Organizing environments, inventory-focused environments",
            "Helping others, hobbies, sports or athletic interests",
            "Collections maintained or collections observed",
            "Frequency and sustained nature of interest",
          ],
          exclude: [
            "Skills like 'inventory management' or 'categorization' (use 'observable_skills')",
            "Task-based abilities like 'quality checking' or 'data tracking' (use 'observable_skills')",
            "Labeling systems, record keeping, or task performance (use 'observable_skills')",
            "Assumed interests without observable evidence",
          ],
          usedFor: [
            "Observable interests in DSR",
            "Emerging vocational themes grounded in what the client cares about",
      ...
      },
      {
        ...
        guidance: {
          purpose: "Document what actions or tasks the client chooses to do—the THINGS they prefer doing. Activities are verbs: actions the person performs or chooses, not the environment or the ability to do them.",
          include: [
            "Organizing supplies, creating lists, sorting donations",
            "Stocking shelves, labeling containers, preparing materials",
            "Inventory tasks, community volunteer activities",
            "Tasks the client chooses when given options",
            "Activities the client initiates without prompting",
            "Things the client requests or talks about positively",
          ],
          exclude: [
            "Broad interests like 'helping others' without specific actions (use 'hobbies_interests_collections')",
            "Skills or abilities (e.g., 'has good attention to detail' — use 'observable_skills')",
            "Personality traits or strengths without activity context (use 'observable_skills')",
            "Activities staff think the client 'should' like",
          ],
          usedFor: [
            "Understanding what the client enjoys DOING",
            "Job matching to tasks and activities",
            "Building job descriptions around preferred actions",
          ],
        },
      },
      {
        ...
        guidance: {
          purpose: "Provide concrete proof that the interest is real and sustained—not speculated. Evidence answers: 'How do you know this is a genuine interest?'",
          include: [
            "Specific observed behaviors showing interest (e.g., 'Sarah organized the pantry shelf three times during the visit without being asked')",
            "Objects owned and maintained (e.g., 'Has a collection of organization labels and color-coded systems at home')",
            "Time spent on the interest (e.g., 'Spends 30-45 minutes daily sorting and reorganizing items')",
            "Direct quotes expressing interest (e.g., 'Sarah said: I like making things neat and organized')",
            "Repeated patterns across visits (e.g., 'Observed organizing behavior on all three home visits')",
            "Photos or field notes documenting evidence (e.g., 'Photo of organized pantry Sarah created')",
          ],
          exclude: [
            "Speculation about interests ('Sarah might like organizing')",
            "Interests stated without proof ('She likes helping')",
            "Assumed interests from reports only without personal observation",
          ],
          usedFor: [
            "Discovery Staging Record evidence sourcing",
            "Building credible vocational themes grounded in observation",
      ...
      },
      {
        ...
        guidance: {
          purpose: "Document abilities the client demonstrates WHILE ENGAGING in their interests—not general skills, but skills shown through the interest activity.",
          include: [
            "Skills shown through the interest (e.g., 'While organizing supplies, Sarah demonstrated: sorting accurately, categorizing items logically, following a system, checking details')",
            "Attention to detail and quality control (e.g., 'Ensures all labels are straight and consistent')",
            "Problem-solving while engaged (e.g., 'When items didn't fit, Sarah repositioned them logically')",
            "Planning and sequencing (e.g., 'Creates a plan before organizing a space')",
            "Patience and persistence (e.g., 'Continues organizing project for 45 minutes without interruption')",
            "Following and creating systems (e.g., 'Developed a color-coding system for donations')",
          ],
          exclude: [
            "Generic skill lists not connected to the interest (e.g., 'good communication skills' without connection to organizing)",
            "Skills assumed but not actually demonstrated while engaged in interest",
            "Skills from other sections (use 'observable_skills' for general skills)",
          ],
          usedFor: [
            "Observable skills demonstrated through interests in DSR",
            "Matching interests to jobs where these skills are used",
            "Job matching to skills naturally expressed in preferred activities",
          ],
        },
      },
      {
...

  {
    ...
    questions: [
      ...
      },
      {
        ...
        guidance: {
          purpose: "Document demonstrated abilities and competencies—what the client CAN DO and does well. Skills are abilities shown through performance, not interests, places, or tasks chosen.",
          include: [
            "Inventory management, categorization, quality checking",
            "Data tracking, record keeping, attention to detail",
            "Following written instructions, task persistence",
            "Organizational skills, sorting, labeling",
            "How the skill was demonstrated with specific examples",
            "Context where the skill was shown",
            "Quality or accuracy of execution",
            "Whether support was needed",
          ],
          exclude: [
            "Hobbies or favorite places (use 'hobbies_interests_collections')",
            "Community locations or preferred activities (use 'preferred_activities')",
            "General interests like 'helping others' (use 'hobbies_interests_collections')",
          ...
          usedFor: [
            ...
            "Building job descriptions around client strengths",
...

 {
  ...
  questions: [
    ...
    },
    {
      ...
      type: "textarea",
      placeholder: "Describe what the environment or context must provide for success—supports, structures, supervision.",
      guidance: {
        purpose: "Document what conditions the ENVIRONMENT must provide for the client to succeed. These are not skills, interests, or activities—they are the supports and structures the workplace must have.",
        include: [
          "Predictable routines, written instructions, visual supports",
          "Structured environments, clear expectations",
          "Advance notice of change, consistent supervision",
          "Regular feedback, coaching styles that work",
          "Supports that enabled success (structure, reminders, prompts)",
          "Accommodations that made a difference (rest breaks, quiet area, etc.)",
          "Social or relational conditions (one-on-one, small team, etc.)",
        ],
        exclude: [
          "Skills like 'inventory management' (use 'observable_skills')",
          "Interests like 'helping others' (use 'hobbies_interests_collections')",
          "Activities like 'sorting donations' (use 'preferred_activities')",
          "Employer leads or job suggestions (use 'potential_businesses_or_settings')",
          "Supports never actually tried or observed",
        ],
        usedFor: [
          "Conditions for success in DSR",
          "Job coaching plan and support intensity",
          "Workplace accommodation, structure, and environmental design",
        ],
      },
    },
    {
