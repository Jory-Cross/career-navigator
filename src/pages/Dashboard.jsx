    ...
    <div className="space-y-6">
      ...
      {widgets.stats && (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="cursor-pointer" onClick={() => navigate("/Tasks")}><StatCard label="Pending Tasks" value={pendingTasks} max={tasks.length} icon={ListChecks} color="text-orange-600" bgColor="bg-orange-50" /></div>
        </div>
      )}
